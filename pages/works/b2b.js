    ...
    <Container>
      ...
      <List ml={4} my={4}>
        ...
        <ListItem>
          <Meta>Stack</Meta>
          <span>
            NodeJs, Fastify, MongoDB, RabbitMQ, React, React Native, Redux Saga, Docker-compose
          </span>
        </ListItem>
      </List>
      ...
      <WorkImage src="/images/works/b2b_03.png" alt="B2B" />
      <WorkImage src="/images/works/b2b_04.png" alt="B2B" />
      <WorkImage src="/images/works/b2b_05.png" alt="B2B" />
    </Container>
  </Layout>
)
